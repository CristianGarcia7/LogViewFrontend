...
/**
 * Inline SVG icon set. Stroke uses `currentColor`, so every icon inherits the
 * surrounding text color (i.e. the OP token applied by the parent). No icon
 * library dependency — keeps the bundle lean and the brand fully in control.
 */
const ICONS = {
  search: (
    <>
  ...
  checkCircle: (
    <>
      <path d="M21 11.5V12a9 9 0 1 1-5.34-8.22" />
